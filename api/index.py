"""
Vercel serverless function entry point for Data Analytics Assistant.
This wraps the Flask application for Vercel's Python runtime.
"""
...
# Note: In serverless, this will reset between invocations
...
# Vercel expects an 'app' variable for WSGI
